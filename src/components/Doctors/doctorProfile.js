                    ...
                    <div class="col-md-12">
                      <div class="col-sm-11">
                        <div class="profile-head">
                          <div class="row">
                            <div class="col-md- col-sm-4 col-xs-12 dct_pic">
                              <img
                            ...
                            <div class="col-md-7 col-sm-5 col-xs-12">
                              ...
                              <ul>
                                <li>
                                  <i class="fa fa-briefcase rt_tx"></i> 9 years
                                </li>
                                <li>
                                  <i class="fa fa-map-marker rt_tx"></i> India
                                </li>
                                <li>
                                  <i class="fa fa-home rt_tx"></i> Chamiers
                                  Towers (East Wing), 5<sup>th</sup> Floor, No:
                                  37,
                                </li>
                                <li>
                                  <i class="fa fa-mobile rt_tx"></i>{" "}
                                  <a href="#" title="call">
                                    (+91) 9840550049
                                  </a>
                                </li>
                                <li>
                                  <i class="fa fa-envelope-o rt_tx"></i>
                                  <a href="#" title="mail">
                                    vijayan@rsicms.com
                                  </a>
                                </li>
                          ...
                          <div class="tabbable-line">
                            <div class="mnu_tb">
                              <ul class="nav nav-tabs ">
                                <li class="active" onClick={() => setTabs(0)}>
